...
describe Baukis::Admin::StaffMembersController, 'ログイン前' do
  it_behaves_like 'a protected admin controller'
end

describe Baukis::Admin::StaffMembersController do
  ...
  describe '#crate' do
    example '職員一覧ページにリダイレクト' do
      post :create, params: {baukis_staff_member:params_hash}
      expect(response).to redirect_to(baukis_admin_staff_members_url)
    end
