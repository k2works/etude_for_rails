...
#               edit_awesome_events_event_ticket GET    /awesome_events/events/:event_id/tickets/:id/edit(.:format) awesome_events/tickets#edit
#                    awesome_events_event_ticket GET    /awesome_events/events/:event_id/tickets/:id(.:format)      awesome_events/tickets#show
#                                                PATCH  /awesome_events/events/:event_id/tickets/:id(.:format)      awesome_events/tickets#update
#                                                PUT    /awesome_events/events/:event_id/tickets/:id(.:format)      awesome_events/tickets#update
#                                                DELETE /awesome_events/events/:event_id/tickets/:id(.:format)      awesome_events/tickets#destroy
