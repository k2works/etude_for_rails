...
class SalesModeling::Type3::Category < ApplicationRecord
  ...
  has_many :supplier_type_categories, :class_name => 'SalesModeling::Purchase::Supplier', :foreign_key => 'supplier_type_category_id'
  has_many :order_type_categories, :class_name => 'SalesModeling::Purchase::Order', :foreign_key => 'order_type_category_id'
  has_many :stock_type_categories, :class_name => 'SalesModeling::Purchase::Stock', :foreign_key => 'stock_type_category_id'
  has_many :warehouse_type_categories, :class_name => 'SalesModeling::Purchase::Warehouse', :foreign_key => 'warehouse_type_category_id'
end
